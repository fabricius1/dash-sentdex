...
dict_data = {'Oil Temperature': oil_temps,
...
def update_obd_values(times, oil_temps, intake_temps,
                      coolant_temps, rpms, speeds,
                      throttle_pos):
    ...
    if len(times) == 1:
        ...
        for data_of_interest in [oil_temps, intake_temps, coolant_temps,
                                 rpms, speeds, throttle_pos]:
            data_of_interest.append(data_of_interest[-1]
                                    + data_of_interest[-1]*random.uniform(-0.0001, 0.0001))
...
app.layout = html.Div([
    ...
    style={'width': '98%', 'margin-left': 10,
           'margin-right': 10, 'max-width': 500000})
    ...
    for data_name in data_names:
        ...
        graphs.append(html.Div(dcc.Graph(
            ...
            figure={'data': [data],
                ...
                yaxis=dict(range=[min(dict_data[data_name]),
                                  max(dict_data[data_name])]),
